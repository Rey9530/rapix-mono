import { ICompanyDetails, IJobFilterCompany } from '../../interface/jobs';

export const companiesSidebar: IJobFilterCompany[] = [
  {
    id: 1,
    title: 'Industry',
    details: [
...
export const companyDetails: ICompanyDetails[] = [
  ...
  },
  {
    ...
    description:
      'Wide range of technology-driven solutions for different sectors',
    jobs_posted: '10',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    category: 'Development',
    description:
      'Software and digital solutions for a range of global businesses',
    jobs_posted: '01',
  },
  {
    id: 10,
