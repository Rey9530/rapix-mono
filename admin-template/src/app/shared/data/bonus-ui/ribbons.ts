export const leftRibbons = [
  {
    ...
    ribbon_class: 'primary ribbon-space-bottom',
    ribbon_text: 'SAVE 10%',
  ...
  },
  {
    ...
    ribbon_class: 'secondary ribbon-clip',
    ribbon_text: 'SAVE 50%',
  ...
  },
  {
    ...
    ribbon_class: 'warning ribbon-vertical-left',
    ribbon_text: '<i class="icofont icofont-love"></i>',
  ...
  {
    class: 'ribbon-wrapper',
    ribbon_class: 'info ribbon-bookmark',
    ribbon_text: 'Cashback 20%',
  ...
  },
  {
    ...
    ribbon_class: 'dark ribbon-clip-bottom',
    ribbon_text: '40% OFF',
  ...
  {
    class: 'ribbon-vertical-left-wrapper vertical-lp-space',
    ribbon_class: 'bookmark ribbon-vertical-left ribbon-danger',
    ribbon_text: '<i class="icon-gift"></i>',
    text: 'Ribbon designs use the class of <b>ribbon-vertical-left</b> through create top-start ribbon and common class use "ribbon".',
  },
];
...
export const rightRibbons = [
  {
    class: 'ribbon-wrapper',
    ribbon_class: 'dark ribbon-right',
    ribbon_text: '50% OFF',
  ...
  },
  {
    ...
    ribbon_class: 'primary ribbon-clip-right ribbon-right',
    ribbon_text: 'SAVE 50%',
  ...
  },
  {
    ...
    ribbon_class: 'bookmark ribbon-vertical-right ribbon-secondary',
    ribbon_text: '<i class="icon-signal"></i>',
  ...
  {
    class: 'ribbon-wrapper alert-light-light',
    ribbon_class: 'warning ribbon-bookmark ribbon-right',
    ribbon_text: 'SAVE 20%',
  ...
  },
  {
    ...
    ribbon_class: 'success ribbon-clip-bottom-right',
    ribbon_text: 'Cashback 10%',
  ...
  },
  {
    ...
    ribbon_class: 'danger ribbon-vertical-right',
    ribbon_text: '<i class="fa fa-taxi"></i>',
