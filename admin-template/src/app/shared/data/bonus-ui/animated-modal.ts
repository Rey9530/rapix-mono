...
export const modalInValues: Select2Data = [
  {
  ...
  {
    label: 'Lightspeed',
    options: [{ value: 'lightSpeedIn', label: 'lightSpeedIn' }],
  },
  {
  ...
  {
    label: 'Specials',
    options: [{ value: 'rollIn', label: 'rollIn' }],
  },
];

export const modalOutValues = [
  {
    label: 'Attention Seekers',
    options: [
      { value: 'bounce', label: 'bounce' },
  ...
  {
    label: 'Lightspeed',
    options: [{ value: 'lightSpeedOut', label: 'lightSpeedOut' }],
  },
  {
  ...
  {
    label: 'Specials',
    options: [{ value: 'rollOut', label: 'rollOut' }],
  },
];
