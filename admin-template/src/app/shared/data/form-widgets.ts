...
import {
  ICommonSwitch,
  ICustomSwitch,
  IDisabledOutlineSwitch,
  IState,
  ISwitchIcon,
  ISwitchSizing,
  ITouchSpin,
} from '../interface/form-widgets';
...
export const touchSpinDetails: ITouchSpin[] = [
  {
    id: 1,
    default_value: 0,
    outlined_value: 0,
...
export const customSwitch: ICustomSwitch[] = [
  {
    class: 'primary',
    value: true,
  },
...
export const commonSwitch: ICommonSwitch[] = [
  {
    title: 'Icons switch',
    class: 'col-xl-4 col-sm-6',
    div_class: 'flex-shrink-0 icon-state',
    sub_description:
      ' For defined icons switches, use <code>switch-state</code> and<code> icon-state.</code>',
    item: [
      {
        color_class: 'primary',
        text: 'Primary Switch',
  ...
  },
  {
    ...
    class: 'col-xl-4 col-sm-6',
    sub_description:
      'Use <code>switch-state</code> class to create uncheck switches.',
    item: [
      {
        color_class: 'primary',
  ...
  },
  {
    ...
    sub_description:
      '  Use <code>switch-outline </code>and <code>.icon-state</code> class to create outline with icons.',
    item: [
      {
        color_class: 'primary',
...
export const disabledOutlineSwitch: IDisabledOutlineSwitch[] = [
  {
    class: 'primary',
    value: false,
  },
...
export const switchSizing: ISwitchSizing[] = [
  {
...
export const switchIcon: ISwitchIcon[] = [
  {
