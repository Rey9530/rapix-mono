import { ISupportDB, ITicketListStatus } from '../interface/support-ticket';

export const ticketListStatus: ITicketListStatus[] = [
  {
    status_title: 'Order',
    order: '2,563',
    profit: 9999,
...
export const supportDataTable: ISupportDB[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    progress: '30%',
    extn: 1965,
    email: 't.fitzpatrick@datatables.ne',
  },
  {
    id: 16,
    img: 'assets/images/user/4.jpg',
