import { IEmailSidebar, IEmails } from '../interface/email';

export const emailSidebar: IEmailSidebar[] = [
  {
    id: 1,
    title: 'Inbox',
    value: 'inbox',
...
export const emails: IEmails[] = [
  ...
  },
  {
    ...
    description:
      'Confirmation and information about your most recent reservation',
    tag: 'task.doc',
    time: '1:00 PM',
    date: 'Tuesday 25 Jun',
    is_favorite: true,
  ...
  },
  {
    ...
    description:
      'From 2:00 AM to 4:00 AM on May 24, 2024. There will be a system outage during this period',
    tag: 'Maintenance.Zip',
    time: '7 April',
    is_favorite: false,
    is_draft: true,
  ...
  },
  {
    ...
    description:
      'Experience the cosiness, creativity, and teamwork that await you in our brand-new workspace.',
    time: '1 April',
    is_favorite: true,
    is_draft: false,
    is_trash: false,
  ...
  },
  {
    ...
    description:
      'We are happy to notify you that your recent order (#224820098) has been verified!',
    time: '1:00 PM',
  ...
  },
  {
    ...
    description:
      'Reviewing your account activity and taking the necessary precautions to secure your data is urgently required',
  ...
  },
  {
    ...
    description:
      'For the security of your account, your one-time password (OTP) is crucial. To confirm and safeguard your information, click',
    time: '5 Day ago',
    is_favorite: false,
    is_draft: false,
    is_trash: false,
  ...
  },
  {
    ...
    description:
      'You have a great opportunity to improve your IT abilities and keep current with emerging trends and technology by attending this workshop',
    time: '1 April',
    is_favorite: false,
    is_draft: true,
    is_trash: false,
  ...
  },
  {
    ...
    description:
      'Prepare to enjoy the products you have chosen without any hassles',
    time: '1:00 PM',
    date: 'Monday 01 Jul',
    is_favorite: false,
    is_draft: false,
  ...
  },
  {
    ...
    description:
      'Find special offers & Exclusive offers! for a short time only!',
    tag: 'Import File..',
    time: '4 April',
    is_favorite: false,
    is_draft: false,
  ...
  },
  {
    ...
    description:
      'Use the coupon code SAVE20 at the register to get your savings.',
    time: '5 Day ago',
    is_favorite: true,
    is_draft: true,
    is_trash: false,
