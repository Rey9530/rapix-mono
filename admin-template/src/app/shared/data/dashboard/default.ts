import {
  ...
  IRecentOrders,
  ISalesReportChart,
  ISalesStatisticalChart,
  ITopCustomers,
  IVisitorChart,
} from '../../interface/dashboard/default';
...
export const visitorChart: IVisitorChart = {
  series: [
    {
      name: 'Growth',
...
export const topCustomers: ITopCustomers[] = [
  {
    id: 1,
...
export const salesStatisticalChart: ISalesStatisticalChart = {
  series: [
    {
      name: 'Earning',
...
export const monthlyTargetChart: IMonthlyTargetChart = {
  series: [92.77],
  chart: {
    type: 'radialBar',
    height: 320,
  ...
  description:
    "Revenue Surges! Today's earnings soar to $3653, marking an impressive uptick from last month. Keep the momentum going!",
  targetDetails: [
    {
      title: 'Revenue',
      value: '$20k',
...
export const activityLogs: IActivityLogs[] = [
  {
    id: 1,
...
export const salesReportChart: ISalesReportChart = {
  series: [
    {
      name: 'Refunds',
      type: 'column',
...
export const manageAppointments: IManageAppointments[] = [
  {
    id: 1,
